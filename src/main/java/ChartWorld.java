...
public class ChartWorld extends World
{
    ...
    public ChartWorld() {
        ...
        Point[] points = listpoints.stream().toArray(Point[] ::new); 
        ...
        getBackground().drawImage(createLineChart(150,points,700, 250, Color.WHITE, Color.RED, Color.BLACK, 5), 120, 80);
