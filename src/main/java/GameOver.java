...
public class GameOver extends World
{
    ...
    {    
       ...
       super(1000, 800, 1);
       scaleBackground();
       GreenfootImage img= new GreenfootImage("PLAYER 1:    "+Integer.toString(score1), 25, Color.LIGHT_GRAY, new Color(0, 0, 0, 0));
    ...
    {    
       ...
       super(1000, 800, 1);
       scaleBackground();
       GreenfootImage img1= new GreenfootImage("PLAYER 1:  "+Integer.toString(score1), 25, Color.RED, new Color(0, 0, 0, 0));
       GreenfootImage img2= new GreenfootImage("PLAYER 2:  "+Integer.toString(score2), 25, Color.GREEN, new Color(0, 0, 0, 0));
